		...
		<div class="page">
			...
			<div class="page-content">
                ...
                <div class="container text-center text-dark">
                    <div class="display-1  text-dark mb-5">@yield("code")</div>
					<p class="h5 font-weight-normal mb-7 leading-normal">@yield("message")</p>
					<a class="btn btn-primary  mb-5" href="/{{ app()->getLocale() }}">{{__("Back To Home")}}</a>
				</div>
